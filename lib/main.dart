...
class _MyHomePageState extends State<MyHomePage> {
  ...
  @override
  Widget build(BuildContext context) {
    final mediaGuery = MediaQuery.of(context);
          ...
          child: Column(
            ...
            children: <Widget>[
              if(!isLandScape) Row(
                  ...
                  children: <Widget> [
                    Text('Show Chard', style: Theme.of(context).textTheme.titleMedium,),
                    Switch.adaptive(
